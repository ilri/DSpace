...
parser.add_argument('-f', '--from-field-name', help='Name of column with values to be replaced.', required=True)
...
parser.add_argument('-t', '--to-field-name', help='Name of column with values to replace.', required=True)
